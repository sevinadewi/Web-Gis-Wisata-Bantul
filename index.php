                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">Kabupaten Bantul</h1>

                            <h6 class="text-center" style="color: #FFF1CA;">Pemetaan Geografis Wisata Bantul</h6>
                            ...
                            <div class="custom-block bg-white shadow-lg">
                                ...
                                <a href="index.php">
                                    <div class="d-flex">
                                        ...
                                        <p class="mb-0">Lihat wilayah wisata di Bantul seperti pantai, hutan, budaya dan lainnya.</p>
                                        </div>
                                        <span class="badge bg-design rounded-pill ms-auto">Map</span>
                                    </div>
                            ...
                            <div class="custom-block custom-block-overlay">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="custom-block-overlay-text d-flex">
                                        <div>
                                            <h5 class="text-white mb-2">Sistem Informasi Geografis</h5>
...
<footer class="site-footer section-padding">
        ...
        <script>
            ...
            // Load geojson dari file lokal atau endpoint
            fetch('geojson/bantul.geojson')
                ...
                miniMap.fitBounds(geoLayer.getBounds()); // otomatis sesuaikan tampilan
                });
            });
        </script>
